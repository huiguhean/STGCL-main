...
class AGCRN(nn.Module):
    def __init__(self, num_nodes, embed_dim, in_dim, out_dim, rnn_units, num_layers, cheb_k, horizon):
        ...
        self.node_embeddings = nn.Parameter(torch.randn(num_nodes, embed_dim), requires_grad=True)#node_embeddings[307*10]
    ...
    def forward(self, source, em_t=None):
        ...
        output, _ = self.encoder(source[:,:,:,:1], init_state, self.node_embeddings, em_t)#node_embeddings[307*10]
